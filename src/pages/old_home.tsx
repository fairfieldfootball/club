...
import { HomePage as Page, InSeason, PostSeason, PreSeason } from '../components';
import {
  draftsActions,
  managersActions,
  matchupsActions,
...
class HomePage extends React.Component<Props> {
  componentDidMount() {
    const { fetchDraft, fetchManagers, fetchMatchups, fetchSeason, fetchStandings } = this.props;
  ...
  render() {
    const { activeMenuKey, managers, matchups, seasons, standings, drafts, user, year } = this.props;
    ...
    return (
      <Page year={normalizedYear} week={season.recent_week}>
